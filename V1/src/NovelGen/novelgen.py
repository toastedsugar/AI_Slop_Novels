...
from src.utils.prompt_render import render_character_prompt, render_system_prompt, render_location_prompt, render_chapter_prompt, render_object_prompt
from src.utils.api_calls import generate_openai, generate_ollama, generate_claude, generate_gemini, generate_xai
...
class NovelGen:
    def __init__(self, blueprint:Blueprint):
        ...
        # build user prompt for chapter 5
        user_prompt = self.build_user_prompt(5)
        #print (user_prompt)
