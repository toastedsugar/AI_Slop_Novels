...
from prompts.outline_barebones import GEN_OUTLINE_SYSTEM_PROMPT, GEN_METADATA_USER_PROMPT, GEN_ROUGH_OUTLINE_USER_PROMPT, GEN_CHARACTERS_USER_PROMPT, GEN_FINAL_OUTLINE_USER_PROMPT
from prompts.generation_barebones import GEN_STORY_SYSTEM_PROMPT, GEN_STORY_USER_PROMPT
